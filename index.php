...
<button id="btnequipe">QUI SOMMES-NOUS ?</button>
</div>
<div id="right">
...
<div class="center">
        ...
        <h4>IN.FLUENCE</h4>
              <div id="bulle">
                  <p>Le pouvoir d'aller au bout<br> de ses rêves</p>

                  <div class="tout">
                     <img class="photojo" src="./img/joaquim.jpeg"></img>
                      <div class="info">
                        <p id="nom">Joaquim JORGE</p>
                         <p id="mail">jojo.jorge@hotmail.fr</p>
                      </div>
                 

                      <svg class="svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!-- Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc.--->
                      <path class="svg" d="M448 296c0 66.3-53.7 120-120 120h-8c-17.7 0-32-14.3-32-32s14.3-32 32-32h8c30.9 0 56-25.1 56-56v-8H320c-35.3 0-64-28.7-64-64V160c0-35.3 28.7-64 64-64h64c35.3 0 64 28.7 64 64v32 32 72zm-256 0c0 66.3-53.7 120-120 120H64c-17.7 0-32-14.3-32-32s14.3-32 32-32h8c30.9 0 56-25.1 56-56v-8H64c-35.3 0-64-28.7-64-64V160c0-35.3 28.7-64 64-64h64c35.3 0 64 28.7 64 64v32 32 72z"/></svg> 
                  </div>
              </div>
            <div class="btn">
                <a  href="./contact.php">PASSER À LA VITESSE SUPÉRIEUR</a>
            </div> 
</div>
...
<!--<ul><p id="dicton">Le pouvoir d'aller au bout de ses rêves</p>
                  ...
                  <li>
                          ...
                          <div id="infojo"> <div id="imgperso">
                                     <img src="./img/joaquim.jpeg" alt="photocreateur2">
                          </div>
                              <p id="photojo">Joaquim JORGE</p>
                              <p id="mail">jojo.jorge@hotmail.fr</p> 
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><!--! Font Awesome Pro 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. <path d="M448 296c0 66.3-53.7 120-120 120h-8c-17.7 0-32-14.3-32-32s14.3-32 32-32h8c30.9 0 56-25.1 56-56v-8H320c-35.3 0-64-28.7-64-64V160c0-35.3 28.7-64 64-64h64c35.3 0 64 28.7 64 64v32 32 72zm-256 0c0 66.3-53.7 120-120 120H64c-17.7 0-32-14.3-32-32s14.3-32 32-32h8c30.9 0 56-25.1 56-56v-8H64c-35.3 0-64-28.7-64-64V160c0-35.3 28.7-64 64-64h64c35.3 0 64 28.7 64 64v32 32 72z"/></svg>
